...
This repository contains the analysis pipeline for evaluating the relationship between postoperative breast implant ratios and perceived aesthetic and naturalness ratings.

## Structure

R/
  build_analysis_dataset.R   # data cleaning pipeline

data/
  raw/                       # raw survey data (not included)
...
3. Cleaned datasets will be generated in `data/processed/`
